...
generated by :mod:`backtest`. The ``<ticker>`` directory is the tickers argument
with spaces and special characters removed. It filters rows between the specified
