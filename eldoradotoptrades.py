...
The script searches ``./tickers/<start-date>-<end-date>-<filter>/<ticker>.csv``
for per ticker trade summaries generated by :mod:`backtest`. It filters rows between the
